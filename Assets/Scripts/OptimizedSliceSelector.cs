...
public class OptimizedSliceSelector : MonoBehaviour
{
    public Renderer planeRenderer;   // The Renderer displaying the plane
    public int numberOfSlices = 50;  // Number of horizontal slices
    ...
    private bool textureNeedsUpdate = false;  // Tracks if texture needs to be updated
    ...
    void HighlightSlice(int sliceIndex, Color borderColor)
    {
        ...
        // Update only the necessary pixels
